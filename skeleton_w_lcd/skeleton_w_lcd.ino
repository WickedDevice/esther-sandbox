...
//#define WLAN_SSID       "linksys_almond"
//#define WLAN_PASS       "6YEKFGE6YC"
//#define WLAN_SSID       "IthacaGenerator"
//#define WLAN_PASS       "Generator"
...
#define FEED_NAME "CO_sensor"
 ...
 int time = 0;
LiquidCrystal lcd(3, 2, 18, 19, 20, 21);
uint32_t ip;
...
void loop() {
  ...
  delay(100);
  Serial.print("Vgas reading is : "); printDouble(vgas, 6);
  Serial.println();
  Serial.print("Vref reading is : "); printDouble(vref, 6);
  Serial.println();
  //from ADC
  //TODO: look this up
  //lcd.clear();
...
double getGasConc(double vgas, double vref) {
  //Voffset = 0?
