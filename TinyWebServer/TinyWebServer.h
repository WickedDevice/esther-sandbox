...
public:
  ...
  static void send_error_code(WildFire_CC3000_ClientRef client, int code);
  ...
  static inline void end_headers(WildFire_CC3000_ClientRef client) { client.println(); }
  ...
  WildFire_CC3000_ClientRef get_client() { return client_; }
  ...
  virtual boolean read_next_char(WildFire_CC3000_ClientRef client, uint8_t* ch);
...
private:
  ...
  WildFire_CC3000_Server server_;

  char* path_;
  HttpRequestType request_type_;
  WildFire_CC3000_ClientRef client_;
